...
The service itself is distributed as Docker container. Check the [`things `](https://git.willowglen.ca/sq/third-party/mainflux.git/blob/master/docker/docker-compose.yml#L167-L194) service section in 
