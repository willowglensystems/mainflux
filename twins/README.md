...
The service itself is distributed as Docker container. Check the [`twins`](https://git.willowglen.ca/sq/third-party/mainflux.git/blob/master/docker/addons/twins/docker-compose.yml#L35-L58) service section in 
