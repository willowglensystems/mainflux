...
The service itself is distributed as Docker container. Check the [`mqtt-adapter`](https://git.willowglen.ca/sq/third-party/mainflux/blob/master/docker/docker-compose.yml#L219-L243) service section in 
