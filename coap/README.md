...
The service itself is distributed as Docker container. Check the [`coap-adapter`](https://git.willowglen.ca/sq/third-party/mainflux/blob/master/docker/docker-compose.yml#L273-L291) service section in 
