...
import (
	...
	"git.willowglen.ca/sq/third-party/mainflux.git/things/tracing"
	...
	authapi "git.willowglen.ca/sq/third-party/mainflux.git/auth/api/grpc"
	...
	"git.willowglen.ca/sq/third-party/mainflux.git/things/api"
	authgrpcapi "git.willowglen.ca/sq/third-party/mainflux.git/things/api/auth/grpc"
	authhttpapi "git.willowglen.ca/sq/third-party/mainflux.git/things/api/auth/http"
	thhttpapi "git.willowglen.ca/sq/third-party/mainflux.git/things/api/things/http"
	"git.willowglen.ca/sq/third-party/mainflux.git/things/postgres"
	rediscache "git.willowglen.ca/sq/third-party/mainflux.git/things/redis"
	localusers "git.willowglen.ca/sq/third-party/mainflux.git/things/users"
