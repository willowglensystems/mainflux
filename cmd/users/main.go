...
import (
	...
	"git.willowglen.ca/sq/third-party/mainflux.git/users/bcrypt"
	"git.willowglen.ca/sq/third-party/mainflux.git/users/emailer"
	"git.willowglen.ca/sq/third-party/mainflux.git/users/tracing"
	...
	"git.willowglen.ca/sq/third-party/mainflux.git/users/api"
	"git.willowglen.ca/sq/third-party/mainflux.git/users/postgres"
