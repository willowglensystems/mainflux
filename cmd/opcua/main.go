...
import (
	...
	"git.willowglen.ca/sq/third-party/mainflux.git/opcua/api"
	"git.willowglen.ca/sq/third-party/mainflux.git/opcua/db"
	"git.willowglen.ca/sq/third-party/mainflux.git/opcua/gopcua"
	"git.willowglen.ca/sq/third-party/mainflux.git/opcua/redis"
