...
The service itself is distributed as Docker container. Check the [`boostrap`](https://git.willowglen.ca/sq/third-party/mainflux/blob/master/docker/addons/bootstrap/docker-compose.yml#L32-L56) service section in 
